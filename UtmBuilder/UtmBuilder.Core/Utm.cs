...
public class Utm
{
    ...
    /// <summary>
    /// Url (utm_url) - The URL of the page where the tag will be placed.
    /// </summary>
    public Url Url { get; }

    /// <summary>
    ///  Campaign (utm_campaign) - Used for keyword analysis. Use utm_campaign to identify a specific product promotion or strategic campaign.
    /// </summary>
